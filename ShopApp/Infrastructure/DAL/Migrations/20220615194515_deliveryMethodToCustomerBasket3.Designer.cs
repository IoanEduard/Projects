...
namespace Infrastructure.DAL.Migrations
{
    ...
    [Migration("20220615194515_deliveryMethodToCustomerBasket3")]
    partial class deliveryMethodToCustomerBasket3
    {
            ...
            modelBuilder.Entity("Core.Entities.BasketItem", b =>
                {
                    ...
                    b.Property<Guid>("CustomberBasketId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("CustomerBasketId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomberBasketId");

                    b.HasIndex("CustomerBasketId1");
            ...
            modelBuilder.Entity("Core.Entities.BasketItem", b =>
                {
                    b.HasOne("Core.Entities.CustomerBasket", "CustomerBasket")
                        .WithMany()
                        .HasForeignKey("CustomberBasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.CustomerBasket", null)
                        .WithMany("Items")
                        .HasForeignKey("CustomerBasketId1");
