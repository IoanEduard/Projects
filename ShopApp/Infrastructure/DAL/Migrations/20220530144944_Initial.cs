        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomberBasketId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerBasketId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketItems_CustomerBasket_CustomberBasketId",
                        column: x => x.CustomberBasketId,
                        principalTable: "CustomerBasket",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketItems_CustomerBasket_CustomerBasketId1",
                        column: x => x.CustomerBasketId1,
                        principalTable: "CustomerBasket",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_CustomberBasketId",
                table: "BasketItems",
                column: "CustomberBasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_CustomerBasketId1",
                table: "BasketItems",
                column: "CustomerBasketId1");
